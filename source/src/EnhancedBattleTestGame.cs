...
namespace Modbed
{
    public class EnhancedBattleTestGame : TaleWorlds.Core.GameType
    {
        ...
        public static EnhancedBattleTestGame Current
        {
            get
            {
                return Game.Current.GameType as EnhancedBattleTestGame;
            }
        }

        public EnhancedBattleTestGame()
        {
        }
        ...
        private void AddGameModels(IGameStarter basicGameStarter)
        {
            ...
            basicGameStarter.AddModel((GameModel)new EnhancedBattleTestSkillList());
