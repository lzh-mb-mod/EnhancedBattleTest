...
namespace EnhancedBattleTest.Data
{
    ...
    public class SceneDataComparer : IEqualityComparer<SceneData>
    {
        public bool Equals(SceneData x, SceneData y)
        {
            ...
            return string.Equals(x.SceneID, y.SceneID, StringComparison.Ordinal) && x.Terrain == y.Terrain && x.IsSiegeMap == y.IsSiegeMap && x.IsVillageMap == y.IsVillageMap;
        }
        ...
        public int GetHashCode(SceneData obj)
        {
            unchecked
            {
                var hashCode = (obj.SceneID != null ? obj.SceneID.GetHashCode() : 0);
