...
namespace EnhancedBattleTest.Multiplayer.Data.MissionData
{
    public class MPAgentOrigin : EnhancedBattleTestAgentOrigin
    {
        ...
        public override Agent SpawnTroop(BattleSideEnum side, bool hasFormation, bool spawnWithHorse, bool isReinforcement, int formationTroopCount, int formationTroopIndex, bool isAlarmed, bool wieldInitialWeapons, bool forceDismounted = false, Vec3? initialPosition = null, Vec2? initialDirection = null, string specialActionSet = null, ItemObject bannerItem = null, FormationClass formationIndex = FormationClass.NumberOfAllFormations)
        {
