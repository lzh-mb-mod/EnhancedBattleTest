...
namespace EnhancedBattleTest.Multiplayer.Config
{
    public class MPCharacterConfig : CharacterConfig
    {
        ...
        public string CharacterId
        {
            ...
            set
            {
                if (value == null)
                    return;
                var heroClass = TaleWorlds.Core.Game.Current.ObjectManager.GetObject<MultiplayerClassDivisions.MPHeroClass>(value);
                if (heroClass == null)
                    return;
                _characterId = value;
                HeroClass = heroClass;
        ...
        {
            CharacterId = TaleWorlds.Core.Game.Current.ObjectManager.GetObjectTypeList<MultiplayerClassDivisions.MPHeroClass>().First().StringId;
        }
